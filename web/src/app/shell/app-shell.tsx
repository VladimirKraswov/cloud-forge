          ...
          <header className="sticky top-0 z-40 border-b border-border bg-background/80 backdrop-blur">
            <div className="mx-auto flex h-18 max-w-7xl items-center gap-4 px-4 py-4 sm:px-6 lg:px-8">
              ...
              <div className="relative hidden max-w-md flex-1 md:block">
                ...
                <Input readOnly value="" placeholder="Search jobs, runs, workers..." className="h-11 rounded-2xl border-border bg-card pl-10" />
              </div>
              ...
              <div className="ml-auto flex items-center gap-3">
                ...
                <div className="flex items-center gap-3 rounded-full border border-border bg-card px-2.5 py-1.5 shadow-[var(--shadow-soft)]">
                  <div className="flex h-9 w-9 items-center justify-center rounded-full bg-primary/10 text-primary">CF</div>
